...
import 'package:medicare/doctor screen/login doctor/login_doctor.dart';

class WelcomeScreenDoctor extends StatelessWidget {
  const WelcomeScreenDoctor({Key? key}) : super(key: key);
...
SizedBox(height: 0,),
          Text("Doctor",style:TextStyle(color: Colors.blueGrey,fontWeight: FontWeight.bold,fontSize: 22) ,),
          SizedBox(height: 0,),
