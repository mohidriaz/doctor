...
List<Map> categories = [
  {'icon': Icons.category, 'text': 'Category'},
  {'icon':Icons.child_care, 'text': 'Child Specialist'},
  {'icon': Icons.monitor_heart_outlined, 'text': 'Cardiologist'},
  {'icon': Icons.health_and_safety, 'text': 'Dentist'},
